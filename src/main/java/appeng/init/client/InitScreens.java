...
import appeng.client.gui.implementations.StorageStockpileSwitchScreen;
...
public final class InitScreens {
    ...
    public static void init() {
        ...
        register(StorageStockpileSwitchMenu.TYPE, StorageStockpileSwitchScreen::new, "/screens/stockpile_switch.json");
